...
const Actions = ({ rowData, handleDeleteCategories }) => {
  ...
  return (
    <>
      ...
      {params.categoryId ? (
        <i
          className="fas fa-receipt text-primary mx-1 hoverable_text pointer has_tooltip"
          title="افزودن ویژگی"
          data-bs-placement="top"
          onClick={() =>
      ...
      <i
        ...
        data-bs-toggle="tooltip"
        data-bs-placement="top"
        onClick={() => handleDeleteCategories(rowData)}
      ></i>
    </>
  );
};
